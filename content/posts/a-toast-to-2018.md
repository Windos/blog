...
description = ""
draft = false
image = "/images/2018/12/joe-leahy-391693-unsplash.jpg"
images = ["/images/2018/12/joe-leahy-391693-unsplash.jpg"]
...
In the next day or two, I'll be doing my resolutions for 2019 (including looking back at [this year's ones](https://king.geek.nz/images/2018/01/03/resolution-2018/)), so this isn't going to be along those lines… instead I wanted to touch on one thing that's been really important to me.
...
```powershell
$ToastScript = {
    $Fireworks = 'https://pngimage.net/wp-content/uploads/images/2018/06/fireworks-icon-png-9.png'
