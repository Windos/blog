...
description = ""
draft = false
image = "/images/2019/09/umanoide-8NvFlA8DO6Q-unsplash.jpg"
images = ["/images/2019/09/umanoide-8NvFlA8DO6Q-unsplash.jpg"]
...
This will be my fourth Hacktoberfest, and with any luck the fourth event t-shirt for my wife to eventually claim (not by my choice though!) I've written about the event a couple of times in the past, in [2017](__GHOST_URL__/images/2017/10/01/oct-17/) and [2018](__GHOST_URL__/images/2018/10/02/hacktoberfest-2018/).

## What's a "Hacktoberfest"?

Hacktoberfest is a yearly month long event fostering contributions to open source projects.

{{< figure src="/images/2019/09/Hacktoberfest_19_Events_500x500.png" >}}
