...
description = ""
draft = false
image = "/images/2020/01/franck-v-U3sOwViXhkY-unsplash.jpg"
images = ["/images/2020/01/franck-v-U3sOwViXhkY-unsplash.jpg"]
...
If you're anything like me, you've probably got a bunch of scripts running as scheduled tasks or jobs on a server (or two). UA is a nice step up in [IT maturity](https://www.thinkhdi.com/library/supportworld/images/2018/it-maturity-matters-because-it-matters.aspx.) from that scenario.
...
{{< figure src="/images/2020/01/image-3.png" >}}
