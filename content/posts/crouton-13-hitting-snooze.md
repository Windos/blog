...
description = ""
draft = false
image = "/images/2019/11/sophie-elvis-msC14JchkKU-unsplash.jpg"
images = ["/images/2019/11/sophie-elvis-msC14JchkKU-unsplash.jpg"]
...
{{< figure src="/images/2019/11/image.png" caption="" >}}
...
Dismiss is simply acknowledges the toast and removes it from the screen. It doesn't go to the Action Center to be viewed later, it is gone for good. This is the same behavior as if the user clicked on a toast that had no [on-click action](__GHOST_URL__/images/2017/05/08/crouton-clickable/images/).
...
{{< figure src="/images/2019/11/image-1.png" caption="" >}}
...
{{< figure src="/images/2019/11/image-2.png" caption="" >}}
...
{{< figure src="/images/2019/11/image-3.png" >}}
...
{{< figure src="/images/2019/11/image-4.png" >}}
