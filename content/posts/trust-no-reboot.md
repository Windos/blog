...
description = ""
draft = false
image = "/images/2018/05/1024px-CISV_trust_game.JPG"
images = ["/images/2018/05/1024px-CISV_trust_game.JPG"]
...
{{< figure src="/images/2018/05/trustrelationship.png" >}}
...
Recently I watched [Orin Thomas'](https://twitter.com/orinthomas) New Zealand TechEd session, [30 common tasks you perform using the GUI that you can do faster in Windows PowerShell](http://channel9.msdn.com/Events/TechEd/NewZealand/images/2014/DCIM324). One of the 30 tasks Orin covered was fixing domain trust issues.
