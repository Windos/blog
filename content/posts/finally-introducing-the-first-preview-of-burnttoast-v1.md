...
draft = false
image = "/images/2022/02/photo-1499244571948-7ccddb3583f1.jpg"
images = ["/images/2022/02/photo-1499244571948-7ccddb3583f1.jpg"]
...
aliases = [
    "/images/2022/02/12/finally-introducing-the-first-preview-of-burnttoast-v1/amp/",
    "/images/2022/02/12/finally-introducing-the-first-preview-of-burnttoast-v1/",
    "/images/2022/02/12/finally-introducing-the-first-preview-of-burnttoast-v1"
]
+++

Evidently, this last year has gone by very fast. I [announced](https://toastit.dev/images/2021/04/20/road-to-burnttoast-v1-1/) that I was starting to work on the re-write of BurntToast that will be released as v1 back in April of 2021 and then promptly... didn't get around to working on it. With a job change and generally being busy, BurntToast took a back seat for a while there.
...
That's all well and good if you've got a good understanding of the [underlying XML](https://toastit.dev/images/2020/07/29/anatomy-of-toast/), but arcane if you don't. Where, for example, does the "binding" object fit? How is it different to the "visual" object?
...
{{< figure src="/images/2022/02/image.png" >}}
...
$Builder | Add-BTImage "https://raw.githubusercontent.com/Windos/BurntToast/main/Media/images/BurntToast-Wide.png"
...
New-BTContentBuilder |
    ...
    Add-BTImage "https://raw.githubusercontent.com/Windos/BurntToast/main/Media/images/BurntToast-Wide.png" -PassThru |
    Show-BTNotification
```
...
New-BTContentBuilder |
    ...
    Add-BTImage "https://raw.githubusercontent.com/Windos/BurntToast/main/Media/images/BurntToast-Wide.png" |
    Show-BTNotification
```
