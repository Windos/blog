...
description = ""
draft = false
image = "/images/2019/07/joseph-gonzalez-zcUgjyqEwe8-unsplash.jpg"
images = ["/images/2019/07/joseph-gonzalez-zcUgjyqEwe8-unsplash.jpg"]
slug = "crouton-12"
...
[Last time we talked](__GHOST_URL__/images/2019/07/17/crouton-11/) toast notifications, we covered how you can gracefully update their content. This was achieved through a process called data binding where you specify placeholder "anchors" in your notification in place of the actual text which then maps through to the text to be displayed in a hashtable.
...
{{< figure src="/images/2019/07/English.png" caption="Example Toast in English" >}}

```powershell
New-BurntToastNotification -Text 'Header', 'Body' -DataBinding $Maori
```

{{< figure src="/images/2019/07/Maori.png" caption="Example Toast in Māori" >}}
