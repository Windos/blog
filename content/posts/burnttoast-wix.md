...
description = ""
draft = false
image = "/images/2018/05/thumb-20.jpg"
images = ["/images/2018/05/thumb-20.jpg"]
slug = "burnttoast-wix"
...
My [last post](https://king.geek.nz/images/2018/02/04/burnttoast-appid-installer/) showed off the results I had using the [WiX Toolset](http://wixtoolset.org/) to create a Start Menu shortcut with the necessary metadata embedded to get toasts working properly in newer versions of Windows 10.
...
<Wix xmlns="http://schemas.microsoft.com/wix/images/2006/wi">
    <Product Id="*" UpgradeCode="__GUID1__" Version="1.0.0.0" Language="1033" Name="__NAME__" Manufacturer="__MANUFACTURER__">
        ...
        <Icon Id="__NAME__.ico" SourceFile="__NAME__.ico" /images/>
