...
description = ""
draft = false
image = "/images/2019/02/vinicius-amano-566532-unsplash.jpg"
images = ["/images/2019/02/vinicius-amano-566532-unsplash.jpg"]
...
{{< figure src="/images/2019/02/EntireOrg.png" >}}

Given the [speed difference](https://king.geek.nz/images/2019/02/19/veeam-backup-for-microsoft-office-365-v3/) between Exchange and SharePoint backups (at least before v3), I'd originally opted to split out into two different jobs. One for SharePoint sites (not personal ones) and one for user based items.

This user job backed up Exchange and OneDrive and I was adding people to the jobs manually as migration occurred.

{{< figure src="/images/2019/02/Individual.png" >}}
...
{{< figure src="/images/2019/02/Warnings.png" >}}
...
{{< figure src="/images/2019/02/MailUsers.png" >}}
...
I don't cover it in this post, but everything from this point needs to be bundled up and scheduled to run on a timer to keep the group up to date. I do this with [PowerShell Scheduled Jobs](https://king.geek.nz/images/2018/06/18/powershell-orchestration-with-scheduled-jobs-the-start-of-a-series/).
...
{{< figure src="/images/2019/02/OneDrive.png" >}}
