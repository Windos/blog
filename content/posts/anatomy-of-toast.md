...
description = ""
draft = false
image = "/images/2020/07/joyce-mccown-LAEPsbXOhIM-unsplash.jpg"
images = ["/images/2020/07/joyce-mccown-LAEPsbXOhIM-unsplash.jpg"]
...
aliases = [
    "/images/2020/07/29/anatomy-of-toast/amp/",
    "/images/2020/07/29/anatomy-of-toast/",
    "/images/2020/07/29/anatomy-of-toast"
]
+++
...
{{< figure src="/images/2020/07/ToastExample.png" >}}
...
<toast>
  <visual>
    <binding template="ToastGeneric">
	  ...
	  <text>You have a booking at Wildfire tonight, make sure you know how to get there!</images/text>
	  <image src="C:\Demos\Map.png" hint-removeMargin="false" /images/>
	  <image src="C:\Demos\WildFire.jpg" placement="hero" /images/>
...
{{< figure src="/images/2020/07/image-16.png" >}}
...
{{< figure src="/images/2020/07/image-17.png" >}}
...
{{< figure src="/images/2020/07/image-18.png" >}}
...
It's at this point that you can take your XML document and redistribute it, as described in a [previous post](__GHOST_URL__/images/2018/08/21/crouton-8-i-like-your-code-but-i-dont-want-it-on-all-my-computers/images/). Alternatively, if you want to pop your notification go ahead and submit it.
...
* Hero image by [Joyce McCown](https://unsplash.com/@moonshadowpress?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/s/photos/images/anatomy?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
* WildFire.jpg belongs to [Wildfire Churrascaria](https://www.wildfirerestaurant.co.nz/images/)
