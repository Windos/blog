...
description = ""
draft = false
image = "/images/2019/04/kaitlyn-chow-554372-unsplash.jpg"
images = ["/images/2019/04/kaitlyn-chow-554372-unsplash.jpg"]
...
One of my key features in this update was the option to selectively include or exclude folders from OneDrive for Business jobs. Why? I've [mentioned it before](__GHOST_URL__/images/2018/10/10/my-wish-list-vbo365/), but I really do want our users to be using OneDrive. We're paying for the service, so why not! What I don't want to do is end up backing up terabytes of data that isn't all that important.
...
{{< figure src="/images/2019/05/Full.PNG" caption="Backing up all folders" >}}

{{< figure src="/images/2019/05/Incremental.PNG" caption="Selective folder backup" >}}
