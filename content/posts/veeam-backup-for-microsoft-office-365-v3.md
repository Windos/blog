...
description = ""
draft = false
image = "/images/2019/02/katya-austin-554633-unsplash.jpg"
images = ["/images/2019/02/katya-austin-554633-unsplash.jpg"]
...
I don't know what I was expecting when I clicked through, but I certainly wasn't expecting anything from [my wish list](https://king.geek.nz/images/2018/10/10/my-wish-list-vbo365/) to be in the change notes. Boy was I happy when I saw what was being introduced, I went so far as to start screen shotting my highlights and sending it through to colleagues.
...
{{< figure src="/images/2019/02/VeeamTicket.png" >}}
...
{{< figure src="/images/2019/02/SharePoint-v2.PNG" >}}
...
{{< figure src="/images/2019/02/SharePoint-v3.PNG" >}}
...
{{< figure src="/images/2019/02/OneDrive-v2.PNG" >}}
...
{{< figure src="/images/2019/02/OneDrive-v3.PNG" >}}
...
{{< figure src="/images/2019/02/OneDrive-Selected.PNG" >}}
...
{{< figure src="/images/2019/02/OneDrive-Full-Initial.PNG" >}}

My "Critical" folder test, however?

{{< figure src="/images/2019/02/OneDrive-Selected-Initial.PNG" >}}
