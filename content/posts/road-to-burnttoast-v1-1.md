...
description = ""
draft = false
image = "/images/2021/04/shane-rounce-DNkoNXQti3c-unsplash.jpg"
images = ["/images/2021/04/shane-rounce-DNkoNXQti3c-unsplash.jpg"]
...
In short, the release of the [Windows Community Toolkit v7.0](https://blogs.windows.com/windowsdeveloper/images/2021/03/16/announcing-windows-community-toolkit-v7-0/) in March.
...
{{< figure src="/images/2021/04/image-1.png" >}}
...
It's worth reading the [previous post](__GHOST_URL__/images/2020/08/08/actionable/images/) before we get going so that you know where we are coming from.
...
Invoke-WebRequest -Uri 'https://toastit.dev/images/favicon.png' -OutFile $AppLogo
...
{{< figure src="/images/2021/04/image-2.png" >}}
...
{{< figure src="/images/2021/04/image-3.png" >}}
...
{{< figure src="/images/2021/04/image-4.png" >}}
