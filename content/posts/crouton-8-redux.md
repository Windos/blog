...
description = ""
draft = false
image = "/images/2019/01/ryoji-iwata-669950-unsplash.jpg"
images = ["/images/2019/01/ryoji-iwata-669950-unsplash.jpg"]
...
It feels like only yesterday that I wrote [Crouton #8](https://king.geek.nz/images/2018/08/21/crouton-8-i-like-your-code-but-i-dont-want-it-on-all-my-computers/), but it's actually been over four months. Obviously, time has been flying by recently. I'm revisiting the topic following a question from [@jkrhrt](https://twitter.com/jkrhrt) on Twitter asking for example files, and I figured it might make for a decent mini blog post.
...
{{< figure src="/images/2019/01/UpdatedToastExample.PNG" >}}
