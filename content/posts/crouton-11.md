...
description = ""
draft = false
image = "/images/2019/05/mae-mu-1547158-unsplash.jpg"
images = ["/images/2019/05/mae-mu-1547158-unsplash.jpg"]
slug = "crouton-11"
...
Wow, it feels like forever since I was last able to sit down and write a blog post. What better way to get back into the swing of things than to make good on the post I alluded to in my [last Crouton](__GHOST_URL__/images/2019/04/02/crouton-10/): Updatable Toast Notifications.
...
{{< figure src="/images/2019/07/Replace.gif" caption="Example of replacing a toast by force" >}}
...
{{< figure src="/images/2019/07/FirstToast.PNG" caption="Example toast with a side of data binding" >}}
...
{{< figure src="/images/2019/07/UpdateOnScreen.gif" caption="Updating a toast while it is on-screen" >}}
