...
description = ""
draft = false
image = "/images/2019/09/clem-onojeghuo-NrtSbPWPjxo-unsplash.jpg"
images = ["/images/2019/09/clem-onojeghuo-NrtSbPWPjxo-unsplash.jpg"]
...
It was interesting timing then, that during the week I came across a post by [Justin Yoo](https://twitter.com/justinchronicle) about [refactoring these pipelines](https://devkimchi.com/images/2019/09/04/azure-devops-pipelines-refactoring-technics/). This post really got me thinking about how I could do my own pipelines better, and when I shared it on Twitter, this was bolstered by being linked to [Barbara Forbes'](https://twitter.com/Ba4bes)  [post](https://4bes.nl/images/2019/07/31/getting-started-with-azure-devops-job-and-step-templates-part-1/)(s).
...
{{< figure src="/images/2019/09/image.png" caption="Creating a new GitHub service connection" >}}
...
{{< figure src="/images/2019/09/image-1.png" >}}
