...
description = ""
draft = false
image = "/images/2018/05/thumb-1.png"
images = ["/images/2018/05/thumb-1.png"]
...
{{< figure src="/images/2018/05/nope1.png" >}}
...
{{< figure src="/images/2018/05/folder-1.png" >}}
...
Using a URL that points to that, the updateable help is working flawlessly. Unfortunately, I [don't normally](https://king.geek.nz/images/2016/07/04/home-server-shutdown/) leave this server running 24/7, so I'll need to look for a cheap hosted solution at some stage.
