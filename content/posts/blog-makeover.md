...
description = ""
draft = false
image = "/images/2018/05/james-pond-191811-unsplash.jpg"
images = ["/images/2018/05/james-pond-191811-unsplash.jpg"]
slug = "blog-makeover"
...
It feels odd writing this post so soon after documenting my [blogging workflow](https://king.geek.nz/images/2018/04/26/blog-workflow/). Over the past two days this blog has migrated from [GitHub Pages](https://pages.github.com/) to a self hosted [Ghost](https://ghost.org/) install.
