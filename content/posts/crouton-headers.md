...
description = ""
draft = false
image = "/images/2018/05/thumb-4.jpg"
images = ["/images/2018/05/thumb-4.jpg"]
...
{{< figure src="/images/2018/05/toast.png" >}}
...
As a practical example of this, consider a script that [checks for new questions on Stack Overflow.](https://king.geek.nz/images/2017/03/20/crouton-stackwatch/) Unlike the previous example of this, let's assume that you want to keep track of more than one tag. Headers will allow you to keep these questions organized.

{{< figure src="/images/2018/05/stackwatcher.png" >}}
